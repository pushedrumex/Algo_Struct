...
class PhysExamSearch {
    ...
    public static void main(String[] args) {
        ...
        PhyscData[] x = { // 배열의 요소는 시력순이지 않으면 안됩니다.(내림차순)
                new PhyscData("이나령", 162, 1.5), new PhyscData("유지훈", 168, 1.2), new PhyscData("전서현", 173, 1.0),
                new PhyscData("김한결", 169, 0.8), new PhyscData("이호연", 174, 0.5), new PhyscData("홍준기", 171, 0.2)};
